...
export const INTENT_TO_ACTIVATION: Record<string, string[]> = {
  ...
  "component-create":   ["always", "component-creation", "design-creation"],
  "component-modify":   ["always", "component-creation"],
  "page-layout":        ["always", "design-creation"],
  ...
  "figma-sync":         ["always", "figma-canvas-operation"],
  "code-generate":      ["always", "component-creation"],
  "design-audit":       ["always", "design-review"],
  "design-system-init": ["always", "component-creation", "design-creation"],
  "responsive-layout":  ["always", "design-creation"],
